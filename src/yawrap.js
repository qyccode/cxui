...
;(function(window, undefined){'use strict';
    window.addEventListener("load",function(){
        ...
        for (var i = 0; i < yaw.length; i++) {
            ...
            var yawrapURL = 'http://yawrap.yawzhou.com';
            var author = 'YawZhou && FanyXu';
        ...
        window.console.log("%c " + projectName + " " + version + " " + author + " " + yawrapURL + " ", "background:#2196f3;color:#fff;padding:2px;border-radius:20px;");
    },true);
})(window);
